 ...
 */
class SubsitesDataExtractionController extends ControllerBase {
  ...
  public function subsitesExtraction() {
    ...
    $html_output .= '<p>Subsites and Overview Data extraction<p>';
    ...
    foreach ($node_ids as $node_id) {
      ...
      if ($node->hasField('localgov_subsites_content')) {

        $page_sections = $node->get('localgov_subsites_content')->getValue();
